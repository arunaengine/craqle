...
Craqle uses the MIT-only notice shown below. This is the repository-specific license difference from the shared Aruna style policy.
...
**An authored implementation comment may contain at most two physical source lines per logical comment.** One line is enough when it explains the point. Apply this to ordinary comments, module comments, and source documentation comments.
